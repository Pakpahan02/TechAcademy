    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tabel Admin TA</h5>
              <p>Data Admin TA yang sudah disimpan.</p>
              <a type="button" class="btn btn-primary mb-4" href="forms-registration.php">Tambah Admin</a>

              <!-- News Table -->
              <table class="display table table-bordered mt-4" id="example">
                <thead>
                  <tr>
                    <th scope="col">No</th>
                ...
                <tbody>
                  <?php $nomor = 0;
                  $role = 2;
                  $sql = mysqli_query($conn, "SELECT * FROM user WHERE role = '$role'");
                  while ($result = mysqli_fetch_assoc($sql)) {
                    ...
                    <tr>
                      ...
                      <td>Admin Tech Academy</td>
                      <td>
                        <a href="prosesAdmin.php?hapus=<?php echo $result['id']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus akun ini?')"><i class="bi bi-trash"></i></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
